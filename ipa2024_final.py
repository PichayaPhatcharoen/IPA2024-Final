#######################################################################################
# Yourname: Pichaya Phatcharoen
# Your student ID: 65070155
# Your GitHub Repo: https://github.com/PichayaPhatcharoen/IPA2024-Final
...
ACCESS_TOKEN = "Bearer "+ os.environ.get("token")
...
# 4. Provide the URL to the Webex Teams messages API, and extract location from the received message.
    ...
    #  e.g.  "/66070123 create"
    if message.startswith("/65070155 "):
